...
export const jobSeekerFeatures = [
  ...
  description : "AI-powered algorithm matches you with relevant opportunities based on your skills and preferences."},
  {
    ...
    description:"Create professional resumes with our intutive builder and templates designed by experts."
  },
  {
    icon:MessageSquare,
...
export const employerFeatures = [
  ...
  },
  {
    ...
    description : "All candidates undergo background verfication to ensure you are hiring trustworthy professionals."
  },
  {
    icon:Clock,
    title:"Quick Hirirng",
...
export const navigation_menu=[
 {
 id:"employer-dashboard",name:"Dashboard",
